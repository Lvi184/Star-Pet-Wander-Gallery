...
import { data as catWalkSpritesheetData } from './spritesheets/catWalk';
import { data as catStatesSpritesheetData } from './spritesheets/catStates';
...
export const characters = [
  {
    name: 'hagimi',
    walkTextureUrl: '/assets/角色图/cat_walk.png',
    walkSpritesheetData: catWalkSpritesheetData,
    speed: 0.1,
    isStaticImage: false,
  },
  {
